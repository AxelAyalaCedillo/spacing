...
class Spacing extends Phaser.Scene
{
    ...
    preload()
    {
        ...
        this.load.audio('sonido_explocion', 'sonidos/impacto.wav');
    ...
    crearNave()
    {
        ...
        grupoDisparos = new GrupoDisparos(this);
    ...
    crearOvni()
    {
        ...
        sonidoExplosion = this.sound.add('sonido_explocion', {volumen:1, loop:false} );
    }
